...
const getRealJid = (ctx) => {
  try {
    ...
    // Si es grupo, devolver el JID de grupo
    if (rjid && rjid.endsWith('@g.us')) return rjid;

    // Chats 1 a 1 con JID “@lid”
    if (rjid && rjid.endsWith('@lid')) {
      ...
      console.log('ℹ️ JID @lid sin número: respondiendo al @lid directamente', rjid);
      return rjid;
    }

    // Chats 1 a 1 normales
